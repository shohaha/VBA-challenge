Sub Testing():
    ...
    'Set new variables for Part One
    ...
    'Set new variables for BONUS Part
...
'----------------------------------------------------------------------------------------------------------------------------------------
    ...
    'Location for each ticker name in the summary table for the current worksheet
    ...
    If Not Need_Summary_Table_Header Then
...
'----------------------------------------------------------------------------------------------------------------------------------------
    ...
    'BONUS part,do this in the beginning of the for loop Delta_Percent = 0
        Close_Price = 0
...
'----------------------------------------------------------------------------------------------------------------------------------------
    'BONUS part : Populate new Summary table on the right for the current spreadsheet HERE
    ...
    'BONUS part adjustments to resetting counters
                Delta_Percent = 0
                Total_Ticker_Volume = 0
                
            
    'Else - If the cell immediately following a row is still the same ticker name, add to Total Ticker Volume
        Else
